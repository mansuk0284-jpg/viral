...
def main():
    ...
    # 해시태그 (2026-08-24 확장: 4 → 18개, 2026-08-25 재확장: 18 → 44개)
    #   가전 낱말이 든 태그를 고른다. "혼수준비" 처럼 넓은 태그는 드레스·예식장이
    #   대부분이라 걸러내는 데만 힘이 든다 — 남기되 뒤로 뺀다.
    #   기간을 못 고르는 채널은 검색어 수가 곧 표본 크기다(CLAUDE.md 2026-08-25).
    ap.add_argument("--tags", nargs="+", default=[
        ...
        "혼수가전리스트", "신혼집가전", "혼수리스트",
        # 품목 × 혼수·신혼
        "혼수냉장고", "신혼세탁기", "혼수세탁기", "신혼냉장고", "혼수TV",
        "신혼에어컨", "혼수에어컨",
        # 품목 단독 (가전 낱말이 태그 자체에 있음)
        "김치냉장고추천", "건조기추천", "식기세척기추천", "식기세척기",
        "의류관리기", "로봇청소기추천", "공기청정기추천", "인덕션추천",
        # 제품명 (삼성)
        "비스포크", "비스포크냉장고", "무풍에어컨", "그랑데", "에어드레서",
        # 제품명 (LG)
        "엘지오브제", "오브제컬렉션", "워시타워", "트롬", "스타일러", "디오스",
        # 브랜드 × 혼수·유통
        "삼성혼수", "엘지혼수", "삼성스토어", "엘지베스트샵",
