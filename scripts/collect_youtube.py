...
# 검색어 (2026-08-24 확장: 8 → 26개)
#   사용자 지시: "유튜브·인스타 검색어 넓혀서 다시 수집해줘.
#                하지만 기본적으로 가전과 관련된 것이어야 해"
#
# 유튜브는 **기간을 지정할 수 없다.** 검색이 관련도 순으로 섞어 주므로
# 2020년 영상과 2026년 영상이 함께 나온다. 표본을 늘리는 길은 검색어를
# 넓히는 것뿐이다(카페에서 쿼리를 14→34로 늘린 것과 같은 이치).
#
# 모든 검색어에 **가전 낱말이나 가전 제품명**을 넣는다. "혼수 준비" 같은
# 넓은 말만 쓰면 예식장·드레스 영상이 끌려와 걸러내는 데만 힘이 든다.
QUERIES = [
    # 혼수 × 가전 (기본)
    "혼수가전 후기", "혼수가전 추천", "혼수가전 견적", "혼수가전 실패",
    "신혼가전 추천", "신혼가전 후기", "신혼집 가전 리뷰", "가전 졸업",
    "웨딩가전 후기", "혼수가전 브랜드 비교",
    # 품목 × 혼수 — 품목마다 보는 사람이 다르다
    "혼수 냉장고", "혼수 세탁기 건조기", "신혼 TV 추천", "신혼 에어컨",
    "신혼 김치냉장고", "신혼 식기세척기", "신혼 청소기 추천", "신혼 인덕션",
    "신혼 의류관리기", "신혼 정수기",
    # 제품명 — 실사용 후기가 이 이름으로 올라온다
    "비스포크 후기", "LG 오브제 후기", "무풍에어컨 후기",
