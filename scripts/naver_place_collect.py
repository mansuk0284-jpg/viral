...
TARGETS = [
    ...
    # ── 서울 ── 백화점 21곳이 몰려 있어 주요 상권만 고른다
    ("삼성스토어 잠실", "삼성", "서울"), ("LG베스트샵 잠실점", "LG", "서울"),
    ("삼성스토어 강남", "삼성", "서울"), ("LG베스트샵 강남점", "LG", "서울"),
    ("삼성스토어 영등포", "삼성", "서울"), ("LG베스트샵 영등포점", "LG", "서울"),
    ("삼성스토어 노원", "삼성", "서울"), ("서울 노원 LG베스트샵", "LG", "서울"),
    ("삼성스토어 목동", "삼성", "서울"), ("LG베스트샵 목동점", "LG", "서울"),
    ("삼성스토어 청량리", "삼성", "서울"), ("LG베스트샵 청량리점", "LG", "서울"),
    # ── 경기 ──
    ("삼성스토어 수원", "삼성", "경기"), ("LG베스트샵 수원점", "LG", "경기"),
    ("삼성스토어 분당", "삼성", "경기"), ("LG베스트샵 분당점", "LG", "경기"),
    ("삼성스토어 일산", "삼성", "경기"), ("LG베스트샵 일산점", "LG", "경기"),
    ("삼성스토어 동탄", "삼성", "경기"), ("LG베스트샵 동탄점", "LG", "경기"),
    ("삼성스토어 부천", "삼성", "경기"), ("LG베스트샵 부천점", "LG", "경기"),
    ("삼성스토어 평촌", "삼성", "경기"), ("LG베스트샵 평촌점", "LG", "경기"),
    # ── 광역시·도 ──
    ("삼성스토어 인천", "삼성", "인천"), ("LG베스트샵 인천점", "LG", "인천"),
    ("삼성스토어 대구", "삼성", "대구"), ("LG베스트샵 대구점", "LG", "대구"),
    ("삼성스토어 대전", "삼성", "대전"), ("LG베스트샵 대전점", "LG", "대전"),
    ("광주광역시 삼성스토어", "삼성", "광주"), ("LG베스트샵 광주점", "LG", "광주"),
    ("삼성스토어 천안", "삼성", "충남"), ("LG베스트샵 천안점", "LG", "충남"),
    ("삼성스토어 청주", "삼성", "충북"), ("LG베스트샵 청주점", "LG", "충북"),
    ("삼성스토어 전주", "삼성", "전북"), ("LG베스트샵 전주점", "LG", "전북"),
    ("삼성스토어 포항", "삼성", "경북"), ("LG베스트샵 포항점", "LG", "경북"),
    ("삼성스토어 원주", "삼성", "강원"), ("LG베스트샵 원주점", "LG", "강원"),
]
