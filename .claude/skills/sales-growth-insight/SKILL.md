...
## 액션의 주체를 틀리지 마라 (2026-08-23)

**후기는 고객이 쓴다.** 매니저가 할 수 있는 건 **요청·독려**다.
"후기 절대량을 키우세요" 같은 문구는 우리가 후기를 생산한다는 뜻으로 읽혀 잘못이다.

실행 가능한 형태로 적는다:
- 계약 시 **담당 매니저 성함을 안내**하고, 후기에 "○○매니저"를 넣어달라고 구체적으로 요청
- 상담 마무리에 **후기 요청을 습관화** — 그래야 실명 후기가 남는다
- 성수기 **전에** 후기 요청 캠페인(후기는 구매 뒤에 쌓이므로 미리 움직여야 한다)

지표가 낮다 = 우리가 글을 덜 썼다 ❌ / **고객이 우리 이야기를 덜 남겼다** ✅
